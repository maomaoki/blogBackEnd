...
(
    ...
    newsBannerBgImageUrl      varchar(255)                       null comment 'news banner 背景图的URL地址',
    newsBannerTitle           varchar(255)                       null comment 'news banner 的标题',
    newsBannerPrintText       varchar(128)                       null comment 'news banner 打印文字，以JSON列表格式存储',
    slideWrapTitle            varchar(128)                       null comment '随便看看 幻灯片 文字内容',
    slideWrapUrl              varchar(128)                       null comment '幻便看看 幻灯片 url(其实也是我的网址)',
